...
export type QueryBookingsArgs = {
  options?: Maybe<BookingListOptions>;
};
...
export type ProductBookingFilterParameter = {
  createdAt?: Maybe<DateOperators>;
  updatedAt?: Maybe<DateOperators>;
  name?: Maybe<StringOperators>;
  startDate?: Maybe<DateOperators>;
  endDate?: Maybe<DateOperators>;
  seatsAvailable?: Maybe<NumberOperators>;
};

export type ProductBookingSortParameter = {
  id?: Maybe<SortOrder>;
  createdAt?: Maybe<SortOrder>;
  updatedAt?: Maybe<SortOrder>;
  name?: Maybe<SortOrder>;
  ...
  seatsAvailable?: Maybe<SortOrder>;
};

export type ProductBookingListOptions = {
  /** Skips the first n results, for use in pagination */
  skip?: Maybe<Scalars['Int']>;
  /** Takes n results, for use in pagination */
  take?: Maybe<Scalars['Int']>;
  /** Specifies which properties to sort the results by */
  sort?: Maybe<ProductBookingSortParameter>;
  /** Allows the results to be filtered */
  filter?: Maybe<ProductBookingFilterParameter>;
...
export type ProductBooking = Node & {
...
export type ProductBookingList = PaginatedList & {
  __typename?: 'ProductBookingList';
  items: Array<ProductBooking>;
  totalItems: Scalars['Int'];
};

export type ProductBookingFragment = (
  { __typename?: 'ProductBooking' }
  & Pick<ProductBooking, 'id' | 'createdAt' | 'updatedAt' | 'startDate' | 'endDate' | 'seatsAvailable'>
);
...
export type GetBookingForProductVariantQuery = (
  ...
  & { productVariant?: Maybe<(
    ...
    & { bookings: (
      { __typename?: 'ProductBookingList' }
      & Pick<ProductBookingList, 'totalItems'>
      & { items: Array<(
        { __typename?: 'ProductBooking' }
        & ProductBookingFragment
        )> }
      ) }
    )> }
  );
...
export type BookingListOptions = {
  skip?: Maybe<Scalars['Int']>;
  take?: Maybe<Scalars['Int']>;
  sort?: Maybe<BookingSortParameter>;
  filter?: Maybe<BookingFilterParameter>;
};
...
export namespace CreateBooking {
  export type Variables = CreateBookingMutationVariables;
  export type Mutation = CreateBookingMutation;
  export type CreateBooking = (NonNullable<CreateBookingMutation['createBooking']>);
}

export namespace UpdateBooking {
  export type Variables = UpdateBookingMutationVariables;
  export type Mutation = UpdateBookingMutation;
  export type UpdateBooking = (NonNullable<UpdateBookingMutation['updateBooking']>);
}

export namespace GetBookings {
  export type Variables = GetBookingsQueryVariables;
  export type Query = GetBookingsQuery;
  export type Bookings = (NonNullable<GetBookingsQuery['bookings']>);
  export type Items = NonNullable<(NonNullable<(NonNullable<GetBookingsQuery['bookings']>)['items']>)[number]>;
}

export namespace GetBooking {
  export type Variables = GetBookingQueryVariables;
  export type Query = GetBookingQuery;
  export type Booking = (NonNullable<GetBookingQuery['booking']>);
}
...
export type GetBookingQuery = (
  ...
  & { booking?: Maybe<(
    { __typename?: 'Booking' }
    & Pick<Booking, 'id' | 'name' | 'createdAt' | 'startDate' | 'endDate' | 'seatsAvailable'>
  )> }
);
